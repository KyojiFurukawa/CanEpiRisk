...
To support the risk calculation process, we developed the CanEpiRisk package---a comprehensive R package designed to facilitate radiation-associated lifetime risk calculation for ionizing radiation exposure. This package incorporates functions for data input, transferring risk models (ERR, EAR), and calculating risk measures (CER and YLL), providing an interface for risk evaluations under various types of exposure scenarios across different populations. The CanEpiRisk package aims to streamline the analytical workflow, enhance reproducibility, and facilitate future extensions, including inverse odds weighting and other transportability methods. A detailed illustration of the package functionalities and example scripts will be included in the following.
